...
Определите функцию `totalTimeInMinutes`, которая принимает два параметра: первый параметр - количество слоев, которые вы добавили в лазанью, а второй параметр - количество минут, которые лазанья провела в духовке. Функция должна вернуть, сколько минут в общей сложности вы работали над приготовлением лазаньи, что является суммой времени подготовки в минутах и времени в минутах, которое лазанья провела в духовке на данный момент.
